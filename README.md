...
This module provides a simple layer on top of [Jakarta Mail](https://eclipse-ee4j.github.io/mail/) 2.2 (package `jakarta.mail`) including a message builder and a service to send mails via SMTPS.
